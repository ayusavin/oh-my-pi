...
| `app.tools.selectOlder`      | `Alt+K`                                                               | Select the previous tool block (`display.expandScope: block`)                                                                                                                        |
| `app.tools.selectNewer`      | `Alt+J`                                                               | Select the next tool block (`display.expandScope: block`)                                                                                                                            |
